...
class KategoriController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('kategori')->with('success', 'Data stored successfully');
    }
    ...
    public function update(Request $request, $kode_kategori) {
        ...
        return redirect()->route('kategori')->with('success', 'Data edited successfully');
    }

    public function destroy($kode_kategori){
        kategori::where('kode_kategori', $kode_kategori)->delete();
        return redirect()->route('kategori')->with('success', 'Data deleted successfully');
    }
}
