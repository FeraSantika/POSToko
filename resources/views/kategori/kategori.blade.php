                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-action">
                                            <a href="{{route('kategori.edit', $item->kode_kategori)}}" class="action-icon">
                                                <i class="mdi mdi-square-edit-outline"></i>
                                            </a>
                                            <form id="delete-form-{{ $item->kode_kategori }}" action="{{route('kategori.destroy', $item->kode_kategori)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
